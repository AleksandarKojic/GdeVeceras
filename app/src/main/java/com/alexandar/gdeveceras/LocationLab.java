 ...
 *
 * Singleton klasa zaduzena za cuvanje i operacije sa Location podacima
...
public class LocationLab {
    ...
    private LocationLab(Context context){
        ...
        mDatabase = new LocationDatabaseHelper(mContext).getWritableDatabase();
    }
    ...
    public void removeLocationViaUUID(Location location) {
    ...
    private ContentValues getContentValues(Location location) {  // TODO: vidi treba li ovaj metoda da bude static? U knjizi jeste.
